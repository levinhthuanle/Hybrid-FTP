...
\begin{figure}[H]
  ...
  \caption{Basic passive-mode upload. The client trace shows TCP connection and USER/PASS authentication, PASV coordination, STOR, the 150 readiness reply, the 226 completion reply, and the resulting SHA-256 digest.}
